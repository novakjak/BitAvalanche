...
public partial class TorrentTaskViewModel : ViewModelBase
{
    ...
    private int _downloadedValid;
    public int DownloadedValid
    {
        get => _downloadedValid;
        private set
        {
            _downloadedValid = value;
            PercentComplete = (double)value / (double)Torrent.TotalSize;
        }
    }
    ...
    public TorrentTaskViewModel(BT.Torrent torrent)
    {
        Torrent = torrent;
        _name = Torrent.DisplayName;
